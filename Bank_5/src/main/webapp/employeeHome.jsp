...
<script type="text/javascript">
  ...
  function updateProfile(){
    ...
    text += '<div class="divtext">First Name : </div><input class="getfield" type="text" name="fname" value="${efname}" required><br><br>';
    text += '<div class="divtext">Last Name :</div><input class="getfield" type="text" name="lname" value="${elname}" required><br><br>';
    text += '<div class="divtext">Middle Name : </div><input class="getfield" type="text" name="mname" value="${emname}"><br><br>';
    text += '<div class="divtext">Phone : </div><input class="getfield" type="Phone" name="phone" value="${ephone}" required><br><br>';
    text += '<div class="divtext">Alternate Phone : </div><input class="getfield" type="phone" name="altphone" value="${ealtphone}"><br><br>';
    text += '<div class="divtext">Email : </div><input class="getfield" type="Email" name="email" value="${eemail}" required><br><br>';
    text += '<div class="divtext">Address : </div><input class="getfield" type="text" name="address" value="${eaddress}" required><br><br>';
    text += '<div class="divtext">User Name : </div><input class="getfield" type="text" name="uname" value="${euname}" required><br><br>';
    text += '<div class="divtext">Password : </div><input class="getfield" type="Password" name="pass" value="${epass}" required><br><br>';
