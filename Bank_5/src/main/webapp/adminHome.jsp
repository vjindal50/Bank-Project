...
<body><center>
	<div id="headings"><h1>Welcome Admin</h1></div>
	<div>
		...
		<div class="menuanddis">
			<div class="sidemenuandcontent" id="sidemenu">
				<div class="sidemenuitem"><button class="remove" onclick="searchCust()">Search Customer</button></div>
				<div class="sidemenuitem"><button class="remove" onclick="searchCust()">Search Employee</button></div>
				<div class="sidemenuitem"><button class="remove" onclick="searchCust()">Search Account</button></div>
				<div class="sidemenuitem"><form action="viewCustLog" method="post"><input class="remove" type="submit" name="submit" value="View Customer Log"></form></div>
				<div class="sidemenuitem"><form action="viewCustLog" method="post"><input class="remove" type="submit" name="submit" value="View Employee Log"></form></div>
				<div class="sidemenuitem"><form action="viewCustLog" method="post"><input class="remove" type="submit" name="submit" value="View Account Log"></form></div>
				
				<div class="sidemenuitem"><form action="logout" method="post"><input class="remove" id="logout" type="submit" name="submit" value="Logout"></form></div>
			</div>
